...
write.table(table,paste("/home/meng/Ped-sim/EUR_miss",miss,"_model_selection_RF_table_relationship_degree1_err",err,".",fam,"fam.txt",sep=''),quote=F,row.names = F,col.names = F)
