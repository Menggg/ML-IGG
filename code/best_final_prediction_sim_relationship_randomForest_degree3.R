...
cycles=10
base=c(3)
rest=c(15,1,9,12,13,10,16,3,11,2,4,6,17)+4
...
write.table(results1,paste("EUR_best_final_RF_table_relationship_degree3_err",j,".100fam.txt",sep=''),quote=F,row.names = F,col.names = F)
