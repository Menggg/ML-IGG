...
cycles=10
base=c(3)
rest=c(12,9,14,16,10,13,1,4,17,6,7,11,15,2,3)+4
...
write.table(results1,paste("EUR_best_final_RF_table_relationship_degree2_err",j,".100fam.txt",sep=''),quote=F,row.names = F,col.names = F)
